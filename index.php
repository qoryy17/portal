...
<body>
    ...
    <div class="container portal-container">
        ...
        <div class="d-flex justify-content-center flex-wrap" id="tombol-container">
            <a target="_blank" href="http://192.168.1.147/SIPP330" class="btn btn-portal">SIPP</a>
            <a target="_blank" href="http://192.168.1.147/mis" class="btn btn-portal">MIS SIPP</a>
            <a target="_blank" href="http://192.168.1.147/ptsp" class="btn btn-portal">PTSP+</a>
            <a target="_blank" href="http://siwakjon3.local" class="btn btn-portal">SIWAKJON</a>
